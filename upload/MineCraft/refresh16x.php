...
if (mysql_num_rows($result) != 1)
    logExit("[refresh16x.php] refresh process, wrong accessToken/clientToken pair");
...
vtxtlog("[refresh16x.php] refresh process [Success] User [$login] NewSession [$sessid] OldSession[$sessionid]");
